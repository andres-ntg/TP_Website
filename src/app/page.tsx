  ...
  return (
    <main>
      ...
      <TextReveal className="mt-0 text-justify">
        Tu socio estratégico en turismo! En Travel Place, somos un operador
        mayorista con alianzas estratégicas diseñadas para ser el mejor aliado
        de los agentes de viajes, trabajando juntos para garantizar la
        satisfacción de cada viajero. Nuestro equipo de expertos en turismo se
        especializa en ofrecer productos que aportan valor, facilitan la labor
        de los agentes y cumplen con las más altas expectativas de los viajeros.
      </TextReveal>
