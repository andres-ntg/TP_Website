  ...
  return (
    <div>
      <ImagesSlider className="h-[40rem]" images={images}>
        ...
        >
          <img
            className="h-[100px] w-auto white"
            src="TravelPlace_isotipo.png"
            alt="Travel Place Logo"
          />
          ...
          <VelocityScroll
            defaultVelocity={1}
            numRows={1}
            className="z-50 text-white text-base md:text-3xl"
          >
            Hoteles • Autos • Seguros • Paquetes • Trenes • Tours • Traslados •
            Bodas •
          </VelocityScroll>
          ...
          <div className="bg-red w-full -mb-50 md:-mb-32">
            <img
              src="/hero_waves_mod.svg"
              alt="Hero Waves"
              className="w-full max-w-screen mx-auto h-auto lg:max-x-[100.0%] "
            />
          </div>
        </motion.div>
      </ImagesSlider>
