    ...
    <div>
      <div className="relative flex h-[500px] w-full flex-col items-center justify-center overflow-hidden">
        <div className="flex w-full flex-col md:flex-row mr-auto">
          ...
          <div className="w-full md:w-1/3 p-4 text-center text-black">
            <div className="flex  md:flex-row md:justify-left justify-center items-center space-x-6">
              <a
                href="https://facebook.com/travelplacegt"
                target="_blank"
              ...
              <a
                href="https://instagram.com/@travelplacegt"
                target="_blank"
                rel="noopener noreferrer"
                className="text-purple-900 hover:text-purple-950"
              >
            ...
            <div className="flex flex-col items-center md:items-right space-y-4">
              <div className="flex items-center">
                ...
                <span>
                  Correo:{" "}
                  <a
                    href="mailto:edwin@travelplacegt.com"
                    className="text-purple-950"
                  >
                    edwin@travelplacegt.com
                  </a>
                </span>
              </div>
              <div className="flex items-center">
              ...
              <div className="flex items-center">
                ...
                <span>
                  Dirección:{" "}
                  <a href="" className="text-purple-950">
                    Centro Empresarial <br />
                    San Cristobal Ciudad de Mixco
                  </a>
                </span>
              </div>
            </div>
        ...
        <div className="absolute bottom-0 left-0 w-full -z-10 mb-0 md:-mb-25">
          <img
            src="/Travel-Place-footer-2.svg"
            alt="Travel Place Footer"
            className="w-full"
          />
        </div>
      </div>
